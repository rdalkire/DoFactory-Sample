...
namespace DoFactory_CoreSample.Models
{
    public partial class dofactory_sampleContext : DbContext
    {
        public dofactory_sampleContext()
        {
        }

        public dofactory_sampleContext(DbContextOptions<dofactory_sampleContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\mssqllocaldb;Initial Catalog=dofactory_sample;Integrated Security=True");
            }
        }
